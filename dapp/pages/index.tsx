  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Binance Smart Chain Lottery" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <NavBar />
      <main className="flex flex-col items-center w-full m-auto h-screen bg-[#041e37]">
        <h1 className="text-4xl text-center my-2 py-2">
          Welcome to The Lottery Dapp
        </h1>
        {lotStatus == "0" ? (
          <h3 className="text-3xl text-center m-4 p-4">Lottery Not Started Yet</h3>
        ) : lotStatus == "1" ? (
          <EnterLottery
